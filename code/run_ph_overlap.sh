...
/bin/echo "Arguments: exec noise-and-tda-latest.sif julia --color\=yes code/run_ph_overlap.jl configfile graph"
...
/bin/echo "Arguments: exec noise-and-tda-latest.sif julia --color\=yes code/run_ph_overlap.jl configfile graph" 1>&2
...
echo $graph
echo $configfile
/usr/bin/singularity exec noise-and-tda-latest.sif julia --color\=yes code/run_ph_overlap.jl $configfile $graph
